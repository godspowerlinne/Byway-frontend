...
const Footer = () => {
    return (
        <footer className='p-8 py-14 lg:px-12 xl:px-14 2xl:px-16 flex flex-col-reverse  lg:flex-row gap-12 justify-between items-start h-fit bg-[#1E293B] dark:bg-[#410B65] text-[#CBD5E1]'>
